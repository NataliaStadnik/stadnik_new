...
const Education = () => {
  ...
  return (
    <section
      className="relative py-20 text-zen-white dark:text-zen-dark-text transition-colors duration-300 bg-fixed bg-center bg-cover "
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-black/50 dark:bg-zen-dark-surface/70" />
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {educationConfig.map((item, idx) => (
            <div
              key={idx}
              className="flex flex-col md:flex-row md:items-center justify-between border-b border-zen-white/10 dark:border-zen-dark-border pb-8"
            >
